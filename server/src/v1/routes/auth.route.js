...
const User = require('./../../../mongo/models/profile');
...
router
    .route('/register')
    /**
     * register with email and password: useless at the moment, use profile route for registration instead
     */
...
router
    ...
    .post(async (req, res, _) => {
        ...
        try {
            ...
            password = typeof(password) == "string" && password.trim() != "" ? password : false;
